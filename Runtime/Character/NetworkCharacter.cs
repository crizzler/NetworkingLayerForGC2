...
[DefaultExecutionOrder(ApplicationManager.EXECUTION_ORDER_DEFAULT_EARLIER - 1)]
    public partial class NetworkCharacter : MonoBehaviour
    {
        ...
        /// <summary>
        /// Active movement backend capability used by authoritative reactions and traversal
        /// to temporarily accept animation-driven owner pose updates.
        /// </summary>
        public INetworkOwnerMotionAuthority OwnerMotionAuthority =>
            m_Character?.Driver as INetworkOwnerMotionAuthority;
