...
namespace Arawn.GameCreator2.Networking.Transport.PurrNet
{
    ...
    public static class GC2NetworkValuePackers
    {
        ...
        public static void Write(this BitPacker packer, NetworkPositionState value)
        {
            ...
            packer.Write(value.supportId);
            packer.Write(value.supportLocalPositionX);
            packer.Write(value.supportLocalPositionY);
            packer.Write(value.supportLocalPositionZ);
            packer.Write(value.supportLocalYaw);
            packer.Write(value.flags);
        ...
        public static void Read(this BitPacker packer, ref NetworkPositionState value)
        {
            ...
            packer.Read(ref value.supportId);
            packer.Read(ref value.supportLocalPositionX);
            packer.Read(ref value.supportLocalPositionY);
            packer.Read(ref value.supportLocalPositionZ);
            packer.Read(ref value.supportLocalYaw);
            packer.Read(ref value.flags);
