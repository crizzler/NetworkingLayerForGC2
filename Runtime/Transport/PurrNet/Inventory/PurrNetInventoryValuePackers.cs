...
namespace Arawn.GameCreator2.Networking.Inventory.Transport.PurrNet
{
    ...
    public static class PurrNetInventoryValuePackers
    {
        ...
        static void Register()
        {
            ...
            Hasher.PrepareType(typeof(NetworkMerchantRequest));
            Hasher.PrepareType(typeof(NetworkMerchantResponse));
            Hasher.PrepareType(typeof(NetworkCraftingRequest));
            Hasher.PrepareType(typeof(NetworkCraftingResponse));
            ...
            Hasher.PrepareType(typeof(NetworkCombineRequest));
            Hasher.PrepareType(typeof(NetworkCombineResponse));
            Hasher.PrepareType(typeof(NetworkContentSplitRequest));
            Hasher.PrepareType(typeof(NetworkContentSplitResponse));
            Hasher.PrepareType(typeof(NetworkItemSplitBroadcast));
            Hasher.PrepareType(typeof(NetworkInventoryResyncRequest));
            Hasher.PrepareType(typeof(NetworkPickupState));
            Hasher.PrepareType(typeof(NetworkPickupStateBroadcast));
            Hasher.PrepareType(typeof(NetworkPickupStateSnapshot));
        ...
        public static void Write(this BitPacker packer, NetworkCell value)
        {
            ...
            packer.WriteList(value.StackedItems);
        }
        ...
        public static void Read(this BitPacker packer, ref NetworkCell value)
        {
            ...
            packer.ReadArray(ref value.StackedItems);
        }
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkMerchantRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.ClientBagNetworkId);
            packer.Write(value.MerchantNetworkId);
            packer.Write(value.RuntimeIdHash);
            packer.Write((byte)value.Action);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkMerchantRequest value)
        {
            byte action = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
            packer.Read(ref value.ClientBagNetworkId);
            packer.Read(ref value.MerchantNetworkId);
            packer.Read(ref value.RuntimeIdHash);
            packer.Read(ref action);
            packer.Read(ref value.Amount);
            value.Action = (MerchantAction)action;
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkMerchantResponse value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.Authorized);
            packer.Write((byte)value.RejectionReason);
            packer.Write(value.TotalPrice);
            packer.Write(value.NewClientWealth);
            packer.Write(value.NewMerchantWealth);
            packer.Write(value.StateVersion);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkMerchantResponse value)
        {
            byte reason = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            ...
            packer.Read(ref value.Authorized);
            packer.Read(ref reason);
            packer.Read(ref value.TotalPrice);
            packer.Read(ref value.NewClientWealth);
            packer.Read(ref value.NewMerchantWealth);
            packer.Read(ref value.StateVersion);
            value.RejectionReason = (InventoryRejectionReason)reason;
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkCraftingRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.InputBagNetworkId);
            packer.Write(value.OutputBagNetworkId);
            packer.Write(value.ItemHash);
            packer.Write(value.ItemIdString);
            packer.Write(value.RuntimeIdHash);
            packer.Write((byte)value.Action);
            packer.Write(value.Chance);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkCraftingRequest value)
        {
            byte action = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
            packer.Read(ref value.InputBagNetworkId);
            packer.Read(ref value.OutputBagNetworkId);
            packer.Read(ref value.ItemHash);
            packer.Read(ref value.ItemIdString);
            packer.Read(ref value.RuntimeIdHash);
            packer.Read(ref action);
            packer.Read(ref value.Chance);
            value.Action = (CraftingAction)action;
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkCraftingResponse value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.Authorized);
            packer.Write((byte)value.RejectionReason);
            packer.Write(value.CreatedItem);
            packer.WriteList(value.ReturnedItems);
            packer.Write(value.StateVersion);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkCraftingResponse value)
        {
            byte reason = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            ...
            packer.Read(ref value.Authorized);
            packer.Read(ref reason);
            packer.Read(ref value.CreatedItem);
            packer.ReadArray(ref value.ReturnedItems);
            packer.Read(ref value.StateVersion);
            value.RejectionReason = (InventoryRejectionReason)reason;
        }
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkCombineRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.BagNetworkId);
            packer.Write(value.PositionA);
            packer.Write(value.PositionB);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkCombineRequest value)
        {
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
            packer.Read(ref value.BagNetworkId);
            packer.Read(ref value.PositionA);
            packer.Read(ref value.PositionB);
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkCombineResponse value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.Authorized);
            packer.Write((byte)value.RejectionReason);
            packer.Write(value.ResultItem);
            packer.Write(value.ResultPosition);
            packer.Write(value.StateVersion);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkCombineResponse value)
        {
            byte reason = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            ...
            packer.Read(ref value.Authorized);
            packer.Read(ref reason);
            packer.Read(ref value.ResultItem);
            packer.Read(ref value.ResultPosition);
            packer.Read(ref value.StateVersion);
            value.RejectionReason = (InventoryRejectionReason)reason;
        }
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkContentSplitRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.TargetBagNetworkId);
            packer.Write(value.SourcePosition);
            packer.Write(value.Amount);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkContentSplitRequest value)
        {
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
            packer.Read(ref value.TargetBagNetworkId);
            packer.Read(ref value.SourcePosition);
            packer.Read(ref value.Amount);
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkContentSplitResponse value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkContentSplitResponse value)
        {
            byte reason = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkItemSplitBroadcast value)
        {
            packer.Write(value.BagNetworkId);
            packer.Write(value.StateVersion);
            packer.Write(value.SourcePosition);
            packer.Write(value.ResultPosition);
            packer.Write(value.SourceCell);
            packer.Write(value.ResultCell);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkItemSplitBroadcast value)
        {
            packer.Read(ref value.BagNetworkId);
            packer.Read(ref value.StateVersion);
            packer.Read(ref value.SourcePosition);
            packer.Read(ref value.ResultPosition);
            packer.Read(ref value.SourceCell);
            packer.Read(ref value.ResultCell);
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkInventoryResyncRequest value)
        {
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
            packer.Write(value.BagNetworkId);
            packer.Write(value.LastAppliedStateVersion);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkInventoryResyncRequest value)
        {
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
            packer.Read(ref value.BagNetworkId);
            packer.Read(ref value.LastAppliedStateVersion);
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkPickupState value)
        {
            packer.Write(value.PickupId);
            packer.Write(value.Consumed);
            packer.Write(value.ConsumedByActorNetworkId);
            packer.Write(value.StateVersion);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkPickupState value)
        {
            packer.Read(ref value.PickupId);
            packer.Read(ref value.Consumed);
            packer.Read(ref value.ConsumedByActorNetworkId);
            packer.Read(ref value.StateVersion);
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkPickupStateBroadcast value)
        {
            packer.Write(value.State);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkPickupStateBroadcast value)
        {
            packer.Read(ref value.State);
        }

        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkPickupStateSnapshot value)
        {
            packer.Write(value.Timestamp);
            packer.WriteList(value.Pickups);
        }

        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkPickupStateSnapshot value)
        {
            packer.Read(ref value.Timestamp);
            packer.ReadArray(ref value.Pickups);
        }
