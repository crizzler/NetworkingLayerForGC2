...
namespace Arawn.GameCreator2.Networking.Shooter.Transport.PurrNet
{
    ...
    public static class PurrNetShooterValuePackers
    {
        ...
        static void Register()
        {
            ...
            Hasher.PrepareType(typeof(NetworkQuickReloadRequest));
            Hasher.PrepareType(typeof(NetworkReloadResponse));
            Hasher.PrepareType(typeof(NetworkReloadBroadcast));
            Hasher.PrepareType(typeof(NetworkFixJamRequest));
            Hasher.PrepareType(typeof(NetworkFixJamResponse));
            Hasher.PrepareType(typeof(NetworkJamBroadcast));
            Hasher.PrepareType(typeof(NetworkFixJamBroadcast));
            Hasher.PrepareType(typeof(NetworkChargeStartRequest));
            Hasher.PrepareType(typeof(NetworkChargeStartResponse));
            Hasher.PrepareType(typeof(NetworkChargeCancelRequest));
            Hasher.PrepareType(typeof(NetworkChargeBroadcast));
            Hasher.PrepareType(typeof(NetworkSightSwitchRequest));
            Hasher.PrepareType(typeof(NetworkSightSwitchResponse));
            Hasher.PrepareType(typeof(NetworkSightSwitchBroadcast));
            Hasher.PrepareType(typeof(NetworkWeaponState));
            Hasher.PrepareType(typeof(NetworkAimState));
            Hasher.PrepareType(typeof(NetworkShooterCharacterSnapshot));
            Hasher.PrepareType(typeof(NetworkShooterImpactPropSnapshot));
        }
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkQuickReloadRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkQuickReloadRequest value)
        {
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkFixJamRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkFixJamRequest value)
        {
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkFixJamResponse value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkFixJamResponse value)
        {
            byte reason = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkJamBroadcast value)
        {
            packer.Write(value.CharacterNetworkId);
            packer.Write(value.WeaponHash);
        }
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkJamBroadcast value)
        {
            packer.Read(ref value.CharacterNetworkId);
            packer.Read(ref value.WeaponHash);
        }
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkFixJamBroadcast value)
        {
            packer.Write(value.CharacterNetworkId);
            packer.Write(value.WeaponHash);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkFixJamBroadcast value)
        {
            packer.Read(ref value.CharacterNetworkId);
            packer.Read(ref value.WeaponHash);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkChargeStartRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkChargeStartRequest value)
        {
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkChargeStartResponse value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkChargeStartResponse value)
        {
            byte reason = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkChargeCancelRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkChargeCancelRequest value)
        {
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkSightSwitchRequest value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkSightSwitchRequest value)
        {
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
            packer.Read(ref value.CorrelationId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkSightSwitchResponse value)
        {
            packer.Write(value.RequestId);
            packer.Write(value.ActorNetworkId);
            packer.Write(value.CorrelationId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkSightSwitchResponse value)
        {
            byte reason = 0;
            packer.Read(ref value.RequestId);
            packer.Read(ref value.ActorNetworkId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkSightSwitchBroadcast value)
        {
            packer.Write(value.CharacterNetworkId);
            packer.Write(value.WeaponHash);
            packer.Write(value.NewSightHash);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkSightSwitchBroadcast value)
        {
            packer.Read(ref value.CharacterNetworkId);
            packer.Read(ref value.WeaponHash);
            packer.Read(ref value.NewSightHash);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkShooterCharacterSnapshot value)
        {
            packer.Write(value.CharacterNetworkId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkShooterCharacterSnapshot value)
        {
            packer.Read(ref value.CharacterNetworkId);
        ...
        [UsedByIL]
        public static void Write(this BitPacker packer, NetworkShooterImpactPropSnapshot value)
        {
            packer.Write(value.PropNetworkId);
        ...
        [UsedByIL]
        public static void Read(this BitPacker packer, ref NetworkShooterImpactPropSnapshot value)
        {
            packer.Read(ref value.PropNetworkId);
