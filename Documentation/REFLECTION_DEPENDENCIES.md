...
> 
> Scope: `Assets/Plugins/GameCreator2NetworkingLayer/` (current codebase).
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Core/NetworkCorePatchHooks.cs`
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Abilities/NetworkAbilitiesPatchHooks.cs`
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Inventory/NetworkInventoryPatchHooks.cs`
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Stats/NetworkStatsPatchHooks.cs`
- Access: `GetField`, `GetProperty`, `GetMethod`, `SetValue`
- Exact targets:
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Shooter/NetworkShooterPatchHooks.cs`
- Access: `GetField`, `GetProperty`, `GetMethod`, `SetValue`
- Exact targets:
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Melee/NetworkMeleePatchHooks.cs`
- Access: `GetField`, `GetProperty`, `GetMethod`, `SetValue`
- Exact targets:
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Quests/NetworkQuestsPatchHooks.cs`
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Dialogue/NetworkDialoguePatchHooks.cs`
- Access: `GetField`, `SetValue`
- Exact targets:
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Traversal/NetworkTraversalPatchHooks.cs`
- Access: `GetField`, `SetValue`
- Exact targets:
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Quests/NetworkQuestsController.cs`
...
- Files:
  - `Assets/Plugins/GameCreator2NetworkingLayer/Inventory/NetworkInventoryController.Server.cs`
  - `Assets/Plugins/GameCreator2NetworkingLayer/Inventory/NetworkInventoryController.Server.SyncAndHelpers.cs`
- Access: `GetField`, `SetValue`
- Exact targets:
...
- Files:
  - `Assets/Plugins/GameCreator2NetworkingLayer/Melee/NetworkMeleeController.cs`
  - `Assets/Plugins/GameCreator2NetworkingLayer/Melee/VisualScripting/ConditionNetworkMeleeHit.cs`
- Access: `GetField`, `GetValue`
- Exact target:
  - `MeleeStance.m_Attacks` (private field)

### 13) Variables runtime private member access
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Variables/NetworkVariableSync.cs`
- Access: `GetField`, `GetValue`
- Exact targets:
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Combat/NetworkCombatInterceptor.cs`
...
- File: `Assets/Plugins/GameCreator2NetworkingLayer/Editor/Patches/GC2PatchManager.cs`
