...
- Push scope is enforced by the versioned hook at `Assets/Plugins/GameCreator2NetworkingLayer/.githooks/pre-push`.
- Run once per clone to activate it locally: `git config core.hooksPath Assets/Plugins/GameCreator2NetworkingLayer/.githooks`.
