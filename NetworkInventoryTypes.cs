...
namespace Arawn.GameCreator2.Networking.Inventory
{
    ...
    // [LOCAL-EDIT] #INVENTORY-WORLD-OBJECT-REJECT-DIAGNOSTICS
    public enum NetworkPickupFailure : byte
    {
        None = 0,
        WorldObjectNotFound = 1,
        WorldObjectPickupDisabled = 2,
        WorldObjectItemMissing = 3,
        WorldObjectConsumed = 4,
        WorldObjectOutOfRange = 5,
        WorldObjectRuntimeItemFailed = 6
    }

    // [LOCAL-EDIT] #INVENTORY-SERVER-LOOT
    public enum NetworkLootFailure : byte
    {
        None = 0,
        ContainerBagNotFound = 1,
        ContainerIsNotWorldInventory = 2,
        LootContainerMissing = 3,
        LootTableMissing = 4,
        AlreadyGenerated = 5,
        LootRollFailed = 6
    }
    ...
    public struct NetworkPickupResponse
    {
        ...
        public NetworkPickupFailure PickupFailure;
        public bool Authorized;
        public InventoryRejectionReason RejectionReason;
    ...
    // [LOCAL-EDIT] #INVENTORY-SERVER-LOOT
    [Serializable]
    public struct NetworkLootRequest
    {
        public ushort RequestId;
        public uint ActorNetworkId;
        public uint CorrelationId;
        public uint ContainerBagNetworkId;
    }

    // [LOCAL-EDIT] #INVENTORY-SERVER-LOOT
    [Serializable]
    public struct NetworkLootResponse
    {
        public ushort RequestId;
        public uint ActorNetworkId;
        public uint CorrelationId;
        ...
        public InventoryRejectionReason RejectionReason;
        public NetworkLootFailure LootFailure;
    }
